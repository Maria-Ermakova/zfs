...
zpool get all otus - покажет все свойства пула otus
zfs get all otus - показывает все свойства конкретного ZFS-объекта (датасета)
...
#восстанавливаем фс из снэпшота: otus - имя zpool, test - имя dataset zfs, today - snapshot  
zfs receive otus/test@today < otus_task2.file

#ищем то самое сообщение
